...
void gnrc_sixlowpan_nd_init(gnrc_ipv6_netif_t *iface)
{
    ...
    DEBUG("6lo nd: retransmit multicast rtr sol in 10 sec\r\r\n");
        ...
        case ICMPV6_NBR_ADV:
            ...
            switch (ar_opt->status) {
                ...
                case SIXLOWPAN_ND_STATUS_DUP:
                    DEBUG("6lo nd: address registration determined duplicated\r\r\n");
