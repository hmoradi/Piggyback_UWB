...
/**
  ...
  *
  * @file
  * @brief      Definitions and settings for the dw1000
  *
  * @author     Hessam Mohammadmoradi <hmoradi@cs.uh.edu>
  *
  */
#ifndef DW1000_INTERNAL_H
#define DW1000_INTERNAL_H
 ...
 */
#define DW1000_RESET_DELAY      (500U)
#define DW1000_XOSCON_DELAY     (2000U)
//#define Sleep(x)            xtimer_usleep((x*1000))
//#include "compiler.h" //todo are u sure?



uint8_t dw1000_strobe(const dw1000_t *dev, const uint8_t command);
 ...
 */
//uint16_t dw1000_reg_read(const dw1000_t *dev, const uint8_t addr);
//uint16_t dw1000_reg_read(const dw1000_t *dev, const word offset, const uint8_t addr,const size_t len, uint8_t *data);
/**
 ...
 */
//void dw1000_reg_write(const dw1000_t *dev,const word offset, const uint8_t addr,
//                      const uint16_t value);
//void dw1000_reg_write(const dw1000_t *dev,const word offset,
//                      const uint8_t addr,
//                      const byte data[], const size_t len);
///temp
