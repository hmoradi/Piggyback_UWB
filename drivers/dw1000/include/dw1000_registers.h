 ...
 *
 * @file
 * @brief       Register and command definitions for DW1000
 *
 * @author      Hessam Mohammadmoradi <hmoradi@cs.uh.edu>
 */

#ifndef DW1000_REGISTERS_H
#define DW1000_REGISTERS_H
 ...
 * @{
 */
#define DW1000_OPT_AUTOACK          (0x0001)    /**< auto ACKs active */
#define DW1000_OPT_CSMA             (0x0002)    /**< CSMA active */
#define DW1000_OPT_PROMISCUOUS      (0x0004)    /**< promiscuous mode
                                                 *   active */
#define DW1000_OPT_PRELOADING       (0x0008)    /**< preloading enabled */
#define DW1000_OPT_TELL_TX_START    (0x0010)    /**< notify MAC layer on TX
                                                 *   start */
#define DW1000_OPT_TELL_TX_END      (0x0020)    /**< notify MAC layer on TX
                                                 *   finished */
#define DW1000_OPT_TELL_RX_START    (0x0040)    /**< notify MAC layer on RX
                                                 *   start */
#define DW1000_OPT_TELL_RX_END      (0x0080)    /**< notify MAC layer on RX
                                                 *   finished */
/** @} */
 ...
 */
enum {
    DW1000_GOTO_PD,       /**< power down */
    DW1000_GOTO_IDLE,       /**< idle */
    DW1000_GOTO_RX,       /**< receive state */
    DW1000_GOTO_TXON,       /**< transmit packet without CCA */
    DW1000_GOTO_TXONCCA        /**< transmit packet using CCA */
};
