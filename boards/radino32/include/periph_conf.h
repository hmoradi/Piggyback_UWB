 ...
 *
 * @file
 * @brief       Peripheral MCU configuration for the radino32 board
 *
...
static const pwm_conf_t pwm_config[] = {
    {
        ...
        .chan     = { { .pin = GPIO_PIN(PORT_B, 3) /* SCK */,  .cc_chan = 1 },
                      { .pin = GPIO_PIN(PORT_A, 0) /* A0 */, .cc_chan = 0 },
                      { .pin = GPIO_PIN(PORT_A, 3) /* D6 */, .cc_chan = 3 },
                      { .pin = GPIO_PIN(PORT_A, 2) /* D10 */, .cc_chan = 2 },
                  },
        .af       = GPIO_AF1,
        .bus      = APB1
    },
    {
            ...
            .chan     = { { .pin = GPIO_PIN(PORT_B, 1) /* D5 */, .cc_chan = 3 },
                          { .pin = GPIO_PIN(PORT_B, 4) /* D9 */, .cc_chan = 0 },
